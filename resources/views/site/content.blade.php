...
@if(isset($services) && is_object($services) && $services->isNotEmpty())
...
@if(isset($portfolios) && is_object($portfolios) && $portfolios->isNotEmpty())
...
<section id="Portfolio" class="content">
    ...
    <div class="portfolio">
        ...
        <!-- Portfolio Wrapper -->
        <div id="portfolio_wrapper" class="isotope fadeInLeft animated wow" style="position: relative; overflow: hidden; height: 480px;">

            @foreach($portfolios as $k => $portfolio)
                <!-- Portfolio Item -->
                <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;"
                     class="portfolio-item one-four isotope-item {{ $portfolio->filter }}">
                    <div class="portfolio_img">
                        {{ Html::image('assets/img/' . $portfolio->image, 'Portfolio ' . $k) }}
                    </div>
...
@if(isset($employees) && is_object($employees) && $employees->isNotEmpty())
                ...
                @foreach($employees as $k => $employee)
                    ...
                    <div class="team_area">
                        <div class="team_box wow fadeInDown delay-0{{ ($k * 3 + 3) }}s">
                            ...
                            {{ Html::image(asset('assets/img/' . $employee->image), $employee->name) }}
                            <ul>
