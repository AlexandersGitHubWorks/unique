        ...
        DB::table('pages')->insert([
            ...
            'text'  => '<h2>We create <strong>awesome</strong> web templates</h2>
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                            Ipsum
                                            has been the industry\'s standard dummy text printer took a galley of type and
                                            scrambled
        ...
        DB::table('pages')->insert([
            ...
            'text'  => '<h3>Lorem Ipsum has been the industry\'s standard dummy text ever..</h3><br/>
                                        ...
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                            ...
                                            typesetting,
                                            remaining essentially unchanged like Aldus PageMaker including versions of
                                            Lorem
                                            Ipsum.</p>',
            'image' => 'about-img.jpg',
        ]);
